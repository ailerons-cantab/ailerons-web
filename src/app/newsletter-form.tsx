...
export default function NewsletterForm() {
    ...
    return (
        <form
            ...
            onSubmit={(e) => {
                e.preventDefault();
                console.log("newsletter_email_submit:", email);
            }}
        >
            <input
                name="email"
            ...
            <button
                type="submit"
                className="h-9 whitespace-nowrap rounded-r bg-black px-4 text-sm font-medium text-white transition-opacity hover:opacity-90"
            >
                Subscribe
            </button>
        </form>
