                ...
                <div className="bg-white border border-gray-200 rounded-xl shadow-sm p-7">
                    ...
                    {missingParams ? (
                        ...
                        <div className="space-y-4">
                            ...
                            <Link href="/login" className="text-sm font-semibold text-gray-900 hover:opacity-80 text-center block">
                                Go to login
                            </Link>
                        </div>
                    ) : (
                        <form onSubmit={handleSubmit} className="space-y-5">
                            ...
                            <button
                                ...
                                className="w-full rounded-lg bg-slate-900 text-white py-3.5 font-medium hover:opacity-90 transition disabled:opacity-50 disabled:cursor-not-allowed"
                            >
