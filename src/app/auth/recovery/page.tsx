...
export default function RecoveryPage() {
    ...
    const canSubmit = useMemo(() => {
        ...
        return true;
    }, [userId, secret, password, confirm]);
                ...
                <div className="bg-white border border-gray-200 rounded-xl shadow-sm p-7">
                    ...
                    {missingParams ? (
                        <div className="space-y-4">
                            ...
                            <Link href="/auth/forgot" className="block w-full rounded-lg bg-slate-900 text-white py-3.5 font-medium text-center hover:opacity-90 transition">
