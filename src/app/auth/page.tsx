...
import { account, createUser, logout, normaliseUserFromAccount, signIn } from "@/lib/appwrite";
...
export default function AuthPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            isLogin ? await signIn(email, password) : await createUser(email, password, firstName, lastName);
